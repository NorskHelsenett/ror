...
| Feature       | realization     | Reasoning | Documentation                                                    |
| ------------- | --------------- | --------- | ---------------------------------------------------------------- |
| Database      | MongoDB         |           | [MongoDB](../components/core/database/index.md)                  |
| Cache         | Valkey          |           | [Valkey](../components/core/cache/index.md)                      |
| Message queue | RabbitMQ        |           | [Rabbit MQ](../components/core/messagebus/index.md)              |
...
| ---------------- | --------------- | --------- | ---------------------------------------------------------------- |
| Database         | MongoDB         |           | [MongoDB](../components/core/database/index.md)                  |
| Database browser | Mongo Express   |           | [Mongo Express](../components/core/database/mongo-express.md)    |
| Cache            | Valkey          |           | [Valkey](../components/core/cache/index.md)                      |
| Message queue    | RabbitMQ        |           | [Rabbit MQ](../components/core/messagebus/index.md)              |
| Secrets vault    | Hashicorp Vault |           | [Hashicorp Vault](../components/core/vault/index.md)             |
| OIDC Provider    | Dex             |           | [OpenLDAP](../components/core/authentication/dex.md)             |
