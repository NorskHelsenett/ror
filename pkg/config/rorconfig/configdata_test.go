...
func TestConfigDataNumericFallback(t *testing.T) {
	cases := []struct {
		...
		{name: "non numeric", value: ConfigData{Value: "abc"}, wantInt: 0, wantInt64: 0, wantUint: 0, wantUint64: 0, wantUint32: 0},
		{name: "empty", value: ConfigData{Value: ""}, wantInt: 0, wantInt64: 0, wantUint: 0, wantUint64: 0, wantUint32: 0},
	}
