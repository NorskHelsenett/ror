...
const (
	...
	OPERATOR_APPLOG_SECRET_NAME  = "APPLOG_SECRET_NAME" // #nosec G101 Jest the name of the variable holding the value
	...
	TANZU_AGENT_PASSWORD           = "TANZU_PWD"    // #nosec G101 Jest the name of the variable holding the value
	TANZU_AGENT_TOKEN_EXPIRY       = "TOKEN_EXPIRY" // #nosec G101 Jest the name of the variable holding the value
	...
	TANZU_AGENT_PROVIDER           = "PROVIDER"
	TANZU_AGENT_REGION             = "REGION"
