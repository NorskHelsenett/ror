...
var (
	ErrResourceSetEmpty    = fmt.Errorf("resource set is empty")
	ErrUnknownResourceKind = fmt.Errorf("unknown resource kind")
)
...
func NewResourceSetFromStruct(in ResourceSet) (*ResourceSet, error) {
	...
	if len(in.Resources) == 0 {
		...
		return &out, ErrResourceSetEmpty
	}
...
func NewResourceFromStruct(res Resource) (*Resource, error) {
	...
	case "/v1, Kind=Namespace":
		...
		r.common = rortypes.NewCommonFactory(res.NamespaceResource)
	...
	case "/v1, Kind=Node":
		...
		r.common = rortypes.NewCommonFactory(res.NodeResource)
	...
	case "/v1, Kind=PersistentVolumeClaim":
		...
		r.common = rortypes.NewCommonFactory(res.PersistentVolumeClaimResource)
	...
	case "apps/v1, Kind=Deployment":
		...
		r.common = rortypes.NewCommonFactory(res.DeploymentResource)
	...
	case "storage.k8s.io/v1, Kind=StorageClass":
		...
		r.common = rortypes.NewCommonFactory(res.StorageClassResource)
	...
	case "wgpolicyk8s.io/v1alpha2, Kind=PolicyReport":
		...
		r.common = rortypes.NewCommonFactory(res.PolicyReportResource)
	...
	case "argoproj.io/v1alpha1, Kind=Application":
		...
		r.common = rortypes.NewCommonFactory(res.ApplicationResource)
	...
	case "argoproj.io/v1alpha1, Kind=AppProject":
		...
		r.common = rortypes.NewCommonFactory(res.AppProjectResource)
	...
	case "cert-manager.io/v1, Kind=Certificate":
		...
		r.common = rortypes.NewCommonFactory(res.CertificateResource)
	...
	case "/v1, Kind=Service":
		...
		r.common = rortypes.NewCommonFactory(res.ServiceResource)
	...
	case "/v1, Kind=Pod":
		...
		r.common = rortypes.NewCommonFactory(res.PodResource)
	...
	case "apps/v1, Kind=ReplicaSet":
		...
		r.common = rortypes.NewCommonFactory(res.ReplicaSetResource)
	...
	case "apps/v1, Kind=StatefulSet":
		...
		r.common = rortypes.NewCommonFactory(res.StatefulSetResource)
	...
	case "apps/v1, Kind=DaemonSet":
		...
		r.common = rortypes.NewCommonFactory(res.DaemonSetResource)
	...
	case "networking.k8s.io/v1, Kind=Ingress":
		...
		r.common = rortypes.NewCommonFactory(res.IngressResource)
	...
	case "networking.k8s.io/v1, Kind=IngressClass":
		...
		r.common = rortypes.NewCommonFactory(res.IngressClassResource)
	...
	case "aquasecurity.github.io/v1alpha1, Kind=SbomReport":
		...
		r.common = rortypes.NewCommonFactory(res.SbomReportResource)
	...
	case "aquasecurity.github.io/v1alpha1, Kind=VulnerabilityReport":
		...
		r.common = rortypes.NewCommonFactory(res.VulnerabilityReportResource)
	...
	case "aquasecurity.github.io/v1alpha1, Kind=ExposedSecretReport":
		...
		r.common = rortypes.NewCommonFactory(res.ExposedSecretReportResource)
	...
	case "aquasecurity.github.io/v1alpha1, Kind=ConfigAuditReport":
		...
		r.common = rortypes.NewCommonFactory(res.ConfigAuditReportResource)
	...
	case "aquasecurity.github.io/v1alpha1, Kind=RbacAssessmentReport":
		...
		r.common = rortypes.NewCommonFactory(res.RbacAssessmentReportResource)
	...
	case "run.tanzu.vmware.com/v1alpha3, Kind=TanzuKubernetesCluster":
		...
		r.common = rortypes.NewCommonFactory(res.TanzuKubernetesClusterResource)
	...
	case "run.tanzu.vmware.com/v1alpha3, Kind=TanzuKubernetesRelease":
		...
		r.common = rortypes.NewCommonFactory(res.TanzuKubernetesReleaseResource)
	...
	case "vmoperator.vmware.com/v1alpha2, Kind=VirtualMachineClass":
		...
		r.common = rortypes.NewCommonFactory(res.VirtualMachineClassResource)
	...
	case "general.ror.internal/v1alpha1, Kind=KubernetesCluster":
		...
		r.common = rortypes.NewCommonFactory(res.KubernetesClusterResource)
	...
	case "general.ror.internal/v1alpha1, Kind=Provider":
		...
		r.common = rortypes.NewCommonFactory(res.ProviderResource)
	...
	case "general.ror.internal/v1alpha1, Kind=Workspace":
		...
		r.common = rortypes.NewCommonFactory(res.WorkspaceResource)
	...
	case "general.ror.internal/v1alpha1, Kind=KubernetesMachineClass":
		...
		r.common = rortypes.NewCommonFactory(res.KubernetesMachineClassResource)
	...
	case "general.ror.internal/v1alpha1, Kind=ClusterOrder":
		...
		r.common = rortypes.NewCommonFactory(res.ClusterOrderResource)
	...
	case "general.ror.internal/v1alpha1, Kind=Project":
		...
		r.common = rortypes.NewCommonFactory(res.ProjectResource)
	...
	case "general.ror.internal/v1alpha1, Kind=Configuration":
		...
		r.common = rortypes.NewCommonFactory(res.ConfigurationResource)
	...
	case "aquasecurity.github.io/v1alpha1, Kind=ClusterComplianceReport":
		...
		r.common = rortypes.NewCommonFactory(res.ClusterComplianceReportResource)
	...
	case "general.ror.internal/v1alpha1, Kind=ClusterVulnerabilityReport":
		...
		r.common = rortypes.NewCommonFactory(res.ClusterVulnerabilityReportResource)
	...
	case "general.ror.internal/v1alpha1, Kind=Route":
		...
		r.common = rortypes.NewCommonFactory(res.RouteResource)
	...
	case "general.ror.internal/v1alpha1, Kind=SlackMessage":
		...
		r.common = rortypes.NewCommonFactory(res.SlackMessageResource)
	...
	case "general.ror.internal/v1alpha1, Kind=VulnerabilityEvent":
		...
		r.common = rortypes.NewCommonFactory(res.VulnerabilityEventResource)
	...
	case "general.ror.internal/v1alpha1, Kind=VirtualMachine":
		...
		r.common = rortypes.NewCommonFactory(res.VirtualMachineResource)
	...
	case "general.ror.internal/v1alpha1, Kind=VirtualMachineVulnerabilityInfo":
		...
		r.common = rortypes.NewCommonFactory(res.VirtualMachineVulnerabilityInfoResource)
	...
	case "/v1, Kind=Endpoints":
		...
		r.common = rortypes.NewCommonFactory(res.EndpointsResource)
	...
	case "networking.k8s.io/v1, Kind=NetworkPolicy":
		...
		r.common = rortypes.NewCommonFactory(res.NetworkPolicyResource)
	...
	case "infrastructure.ror.internal/v1alpha1, Kind=Datacenter":
		...
		r.common = rortypes.NewCommonFactory(res.DatacenterResource)
	...
	case "backup.ror.internal/v1alpha1, Kind=BackupJob":
		...
		r.common = rortypes.NewCommonFactory(res.BackupJobResource)
	...
	case "backup.ror.internal/v1alpha1, Kind=BackupRun":
		...
		r.common = rortypes.NewCommonFactory(res.BackupRunResource)
	...
	default:
		...
		return nil, fmt.Errorf("%w: %s", ErrUnknownResourceKind, gvk.String())
	}
	return r, nil
}
