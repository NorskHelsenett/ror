...
func (c *V1Client) GetApplicationByUid(ctx context.Context, uid string, ownerSubject string, scope aclmodels.Acl2Scope) (*apiresourcecontracts.ResourceApplication, error) {
	kind := "Application"
